...
| **[22](./docs/22-Nhat-ky-Trien-khai-LZ-DIY.md)** | **Nhật ký triển khai** – lần dựng thật: 27 lỗi gặp phải và cách sửa |
...
**Đã dựng thật một lần, đi hết cả 9 giai đoạn** — [doc 22](./docs/22-Nhat-ky-Trien-khai-LZ-DIY.md) ghi lại 27 lỗi gặp phải và cách sửa, trong đó **23 lỗi nằm ở chính code của repo**. Đọc mục 6 trước khi bắt đầu để đỡ mất thời gian.
