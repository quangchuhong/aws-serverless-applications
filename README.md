...
| **[22](./docs/22-Nhat-ky-Trien-khai-LZ-DIY.md)** | **Nhật ký triển khai** – lần dựng thật: 15 lỗi gặp phải và cách sửa |
...
**Đã dựng thật một lần, đi hết 6/7 giai đoạn** — [doc 22](./docs/22-Nhat-ky-Trien-khai-LZ-DIY.md) ghi lại 15 lỗi gặp phải và cách sửa, trong đó **11 lỗi nằm ở chính code của repo**. Đọc mục 6 trước khi bắt đầu để đỡ mất thời gian.
