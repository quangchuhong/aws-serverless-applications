...
| **[22](./docs/22-Nhat-ky-Trien-khai-LZ-DIY.md)** | **Nhật ký triển khai** – dựng thật, xoá thật, dựng lại: 34 lỗi và cách sửa |
...
**Đã dựng thật, xoá thật, rồi dựng lại** — [doc 22](./docs/22-Nhat-ky-Trien-khai-LZ-DIY.md) ghi lại 34 lỗi gặp phải và cách sửa, trong đó **30 lỗi nằm ở chính code của repo**. Năm lỗi cuối chỉ lộ ra khi đi ngược chiều và khi rà lại guardrail. Đọc mục 6 trước khi dựng, mục 7 trước khi xoá.
