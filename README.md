...
| **[22](./docs/22-Nhat-ky-Trien-khai-LZ-DIY.md)** | **Nhật ký triển khai** – dựng thật, xoá thật, dựng lại: 33 lỗi và cách sửa |
...
**Đã dựng thật, xoá thật, rồi dựng lại** — [doc 22](./docs/22-Nhat-ky-Trien-khai-LZ-DIY.md) ghi lại 33 lỗi gặp phải và cách sửa, trong đó **29 lỗi nằm ở chính code của repo**. Bốn lỗi cuối chỉ lộ ra khi đi ngược chiều và khi rà lại guardrail. Đọc mục 6 trước khi dựng, mục 7 trước khi xoá.
