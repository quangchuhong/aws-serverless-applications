...
# nay. Sao chep no vao day se cho ra ban thu hai roi ban thu ba, va ban
# lech se la ban long hon.
#
# ======================================================================
# CAU HOI KHONG LOP NAO KHAC TRA LOI: APPLY DA CO TAC DUNG CHUA
#
...
#
# TU_THU_MUC van con, va no la DAU VAO chu khong phai che do: doc JSON co
# san thay vi goi AWS, de logic doc ket qua thu duoc ma khong can credential.
########################################
if [[ $# -gt 0 ]]; then
  echo "Script nay khong nhan tham so (nhan duoc: $*)."
  echo "Bien moi truong: TU_THU_MUC."
  exit 2
fi
...
print()
print("  Da kiem: cay OU, SCP, tag policy.")
if loi:
